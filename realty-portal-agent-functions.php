	...
	function rp_agent_custom_social_agent() {
		...
		$list_social = array(
			array(
				...
				'type'  => 'text',
				'icon'  => 'rp-icon-ion-social-facebook',
			),
			array(
